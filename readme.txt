...
5. Now you have the Multiple Map Marker For Elementor Page Builder from the left panel which yu can drag onto the content area.

== Screenshots ==

1. Setup Goolge Map API
2. Use Multiple Map Marker Widget
3. Out of Multiple Map Marker
